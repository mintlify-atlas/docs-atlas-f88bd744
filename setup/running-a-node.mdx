...
<ParamField path="--rpc-url" type="string" default="http://127.0.0.1:8546">
  Core Lane RPC URL
</ParamField>

<ParamField path="--contract" type="address" default="0x0000000000000000000000000000000000000045">
...
<ParamField path="--max-fee-per-gas" type="integer">
  Maximum fee per gas unit (in wei)
</ParamField>

<ParamField path="--max-priority-fee-per-gas" type="integer" default="0">
...
<ParamField path="--rpc-url" type="string" default="http://127.0.0.1:18443">
  Bitcoin RPC URL
</ParamField>

<ParamField path="--rpc-user" type="string">
  Bitcoin RPC username
</ParamField>

<ParamField path="--rpc-password" type="string">
...
<ParamField path="--bitcoin-address" type="string" required>
...
<ParamField path="--max-fee" type="integer" default="1000">
  Maximum fee in satoshis willing to pay solver
</ParamField>

<ParamField path="--expire-by" type="integer" required>
